...
set "BASELINE_WORKSPACE=Best\q5-bp-dual-input-hp-output-sink-trial-0146-workflow\best_run\trial_0146\workspace"
set "TIMESTAMP=area-capdown-best-300-%TS%"
set "CADENCE_WORKERS=%~1"
if "%CADENCE_WORKERS%"=="" set "CADENCE_WORKERS=1"

echo Running 300-trial area-capdown-retune sweep from trial_0146 best workspace.
